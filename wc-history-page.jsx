...
// ============================================================
const WC_HISTORY = [
  { year: 1930, host: 'Uruguay', champion: 'Uruguay', runnerUp: 'Argentina', desc: 'El primer Mundial de la historia se celebró en Uruguay, con solo 13 equipos participantes. Uruguay ganó la final 4-2 ante Argentina en el Estadio Centenario de Montevideo ante 93,000 espectadores.', image: 'https://images.unsplash.com/photo-1615236490988-ec5970e3e78e?w=600&h=380&fit=crop&q=75', color: '#0038A8' },
  { year: 1934, host: 'Italia', champion: 'Italia', runnerUp: 'Checoslovaquia', desc: 'Italia organizó y ganó su primer título en un torneo marcado por la propaganda fascista de Mussolini. Fue el primer Mundial con fase clasificatoria y el primero transmitido por radio.', image: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=600&h=380&fit=crop&q=75', color: '#009246' },
  { year: 1938, host: 'Francia', champion: 'Italia', runnerUp: 'Hungría', desc: 'Italia revalidó su título en Francia, convirtiéndose en el primer bicampeón. El torneo se jugó bajo la sombra de la inminente Segunda Guerra Mundial, que suspendería el Mundial hasta 1950.', image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&h=380&fit=crop&q=75', color: '#002654' },
  { year: 1950, host: 'Brasil', champion: 'Uruguay', runnerUp: 'Brasil', desc: 'El "Maracanazo": Uruguay derrotó a Brasil 2-1 en la final disputada ante 200,000 personas en el Maracanã. Es considerada la mayor sorpresa en la historia del fútbol.', image: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=600&h=380&fit=crop&q=75', color: '#006B2D' },
  { year: 1954, host: 'Suiza', champion: 'Alemania', runnerUp: 'Hungría', desc: 'El "Milagro de Berna": Alemania venció 3-2 a la favorita Hungría en la final. Hungría llegó invicta en 4 años y lideraba 2-0. Esta victoria fue clave para la reconstrucción moral de Alemania.', image: 'https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?w=600&h=380&fit=crop&q=75', color: '#D52B1E' },
  { year: 1958, host: 'Suecia', champion: 'Brasil', runnerUp: 'Suecia', desc: 'Un joven Pelé de 17 años deslumbró al mundo. Brasil ganó su primer título con un fútbol revolucionario, venciendo 5-2 a Suecia en la final. Nació la leyenda del "jogo bonito".', image: 'https://images.unsplash.com/photo-1509356843151-3e7d96241e11?w=600&h=380&fit=crop&q=75', color: '#006AA7' },
  { year: 1962, host: 'Chile', champion: 'Brasil', runnerUp: 'Checoslovaquia', desc: 'Brasil revalidó su título sin Pelé, lesionado en la fase de grupos. Garrincha se convirtió en la estrella del torneo. El Mundial se celebró pese a un devastador terremoto en 1960.', image: 'https://images.unsplash.com/photo-1469041797191-50ace28483c3?w=600&h=380&fit=crop&q=75', color: '#D52B1E' },
  { year: 1966, host: 'Inglaterra', champion: 'Inglaterra', runnerUp: 'Alemania', desc: 'Inglaterra ganó su único título con el polémico "gol fantasma" de Geoff Hurst en la prórroga. Hurst anotó un hat-trick en la final, hazaña única en una final mundialista.', image: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=600&h=380&fit=crop&q=75', color: '#C8102E' },
  { year: 1970, host: 'México', champion: 'Brasil', runnerUp: 'Italia', desc: 'Considerado el mejor Mundial de la historia. Brasil de Pelé, Jairzinho, Rivelino y Tostão jugó el fútbol más bello jamás visto. Ganaron la final 4-1 ante Italia y se quedaron con la Copa Jules Rimet.', image: 'https://images.unsplash.com/photo-1585464231875-d9ef1f5ad396?w=600&h=380&fit=crop&q=75', color: '#006847' },
  { year: 1974, host: 'Alemania', champion: 'Alemania', runnerUp: 'Países Bajos', desc: 'La "Naranja Mecánica" de Johan Cruyff revolucionó el fútbol con el "fútbol total", pero Alemania ganó la final 2-1. Beckenbauer levantó la copa como capitán en Múnich.', image: 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=600&h=380&fit=crop&q=75', color: '#1A1A1A' },
  { year: 1978, host: 'Argentina', champion: 'Argentina', runnerUp: 'Países Bajos', desc: 'Argentina ganó su primer Mundial como local en medio de una dictadura militar. Mario Kempes fue la estrella con 6 goles. El confeti del Monumental se convirtió en imagen icónica.', image: 'https://images.unsplash.com/photo-1589909202802-8f4aadce1849?w=600&h=380&fit=crop&q=75', color: '#75AADB' },
  { year: 1982, host: 'España', champion: 'Italia', runnerUp: 'Alemania', desc: 'Italia, liderada por Paolo Rossi (Bota de Oro con 6 goles), ganó su tercer título tras eliminar a Brasil y Alemania. El torneo amplió su formato a 24 equipos por primera vez.', image: 'https://images.unsplash.com/photo-1543785734-4b6e564642f8?w=600&h=380&fit=crop&q=75', color: '#AA151B' },
  { year: 1986, host: 'México', champion: 'Argentina', runnerUp: 'Alemania', desc: 'El Mundial de Maradona. La "Mano de Dios" y el "Gol del Siglo" contra Inglaterra son los momentos más memorables. Argentina ganó su segundo título con Diego como figura indiscutible.', image: 'https://images.unsplash.com/photo-1518105779142-d975f22f1b0a?w=600&h=380&fit=crop&q=75', color: '#006847' },
  { year: 1990, host: 'Italia', champion: 'Alemania', runnerUp: 'Argentina', desc: 'Conocido como "Italia 90" y sus "Noches Mágicas". Alemania se vengó de Argentina en la final más aburrida (1-0 con penal). Camerún de Roger Milla fue la gran sorpresa del torneo.', image: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=600&h=380&fit=crop&q=75', color: '#009246' },
  { year: 1994, host: 'Estados Unidos', champion: 'Brasil', runnerUp: 'Italia', desc: 'La primera final decidida por penales: Brasil venció a Italia. La imagen de Roberto Baggio fallando el penal decisivo es icónica. Romário fue el mejor jugador del torneo.', image: 'https://images.unsplash.com/photo-1485738422979-f5c462d49f04?w=600&h=380&fit=crop&q=75', color: '#002868' },
  { year: 1998, host: 'Francia', champion: 'Francia', runnerUp: 'Brasil', desc: 'Francia ganó su primer título como local con Zidane anotando dos cabezazos en la final (3-0 a Brasil). El misterio de la convulsión de Ronaldo antes de la final sigue sin resolverse.', image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&h=380&fit=crop&q=75', color: '#002654' },
  { year: 2002, host: 'Corea/Japón', champion: 'Brasil', runnerUp: 'Alemania', desc: 'El primer Mundial en Asia y coorganizado por dos países. Ronaldo se redimió con 8 goles y Brasil ganó su quinto título (2-0 a Alemania). Corea del Sur llegó a semifinales en una hazaña histórica.', image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=600&h=380&fit=crop&q=75', color: '#C60C30' },
  { year: 2006, host: 'Alemania', champion: 'Italia', runnerUp: 'Francia', desc: 'La final recordada por el cabezazo de Zidane a Materazzi. Italia ganó por penales tras el 1-1. Fue el adiós de Zidane y el nacimiento de las Fan Fests oficiales.', image: 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=600&h=380&fit=crop&q=75', color: '#1A1A1A' },
  { year: 2010, host: 'Sudáfrica', champion: 'España', runnerUp: 'Países Bajos', desc: 'El primer Mundial africano. España ganó su primer título con el gol de Iniesta en la prórroga de la final. El tiki-taka español conquistó el mundo al son de las vuvuzelas.', image: 'https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?w=600&h=380&fit=crop&q=75', color: '#007A33' },
  ...
  { year: 2018, host: 'Rusia', champion: 'Francia', runnerUp: 'Croacia', desc: 'Francia ganó su segundo título con una generación dorada liderada por Mbappé. Croacia, con solo 4 millones de habitantes, llegó a su primera final. El VAR se usó por primera vez.', image: 'https://images.unsplash.com/photo-1551524559-8af4e6624178?w=600&h=380&fit=crop&q=75', color: '#C8102E' },
  { year: 2022, host: 'Catar', champion: 'Argentina', runnerUp: 'Francia', desc: 'La mejor final de la historia: Argentina 3-3 Francia (4-2 en penales). Messi ganó su anhelado Mundial a los 35 años. Mbappé anotó un hat-trick en la final. El primer Mundial invernal.', image: 'https://images.unsplash.com/photo-1518684079-3c830dcef090?w=600&h=380&fit=crop&q=75', color: '#8D1B3D' },
];
