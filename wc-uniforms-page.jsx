...
const UNIFORMS_DATA = [
  ...
  { id: 'germany',       group: 'E', brand: 'Adidas',  jerseyImg: 'assets/uniforme alemania.webp',                  celebName: 'Thomas Müller',      role: 'Delantero · Bayern Munich',   celebImg: 'https://upload.wikimedia.org/wikipedia/commons/a/aa/FC_Red_Bull_Salzburg_gegen_Bayern_M%C3%BCnchen_%282025-01-06_Testspiel%29_19.jpg' },
  { id: 'ecuador',       group: 'E', brand: 'Marathon', jerseyImg: 'assets/uniforme ecuador.webp',                  celebName: 'Enner Valencia',     role: 'Delantero · Internacional',   celebImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Enner_Valencia_CONTINUACI%C3%93N_DE_LA_SESI%C3%93N_N.%C2%BA_056_DEL_PLENO_DE_LA_ASAMBLEA_NACIONAL._ECUADOR%2C_09_DE_DICIEMBRE_DE_2025_%28cropped%29.jpg/960px-Enner_Valencia_CONTINUACI%C3%93N_DE_LA_SESI%C3%93N_N.%C2%BA_056_DEL_PLENO_DE_LA_ASAMBLEA_NACIONAL._ECUADOR%2C_09_DE_DICIEMBRE_DE_2025_%28cropped%29.jpg' },
  { id: 'curazao',       group: 'E', brand: 'Adidas',  jerseyImg: 'assets/uniforme curazao.webp',                  celebName: 'Thomas Müller',      role: 'Delantero · Bayern Munich',   celebImg: 'https://upload.wikimedia.org/wikipedia/commons/a/aa/FC_Red_Bull_Salzburg_gegen_Bayern_M%C3%BCnchen_%282025-01-06_Testspiel%29_19.jpg' },
  { id: 'costa de marfil',group: 'E', brand: 'Marathon', jerseyImg: 'assets/uniforme costa de marfil.webp',        celebName: 'Enner Valencia',     role: 'Delantero · Internacional',   celebImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Enner_Valencia_CONTINUACI%C3%93N_DE_LA_SESI%C3%93N_N.%C2%BA_056_DEL_PLENO_DE_LA_ASAMBLEA_NACIONAL._ECUADOR%2C_09_DE_DICIEMBRE_DE_2025_%28cropped%29.jpg/960px-Enner_Valencia_CONTINUACI%C3%93N_DE_LA_SESI%C3%93N_N.%C2%BA_056_DEL_PLENO_DE_LA_ASAMBLEA_NACIONAL._ECUADOR%2C_09_DE_DICIEMBRE_DE_2025_%28cropped%29.jpg' },
  // Grupo F: Países Bajos · Japón · Suecia · Túnez
  { id: 'netherlands',   group: 'F', brand: 'Nike',    jerseyImg: 'assets/uniforme holanda.webp',                        celebName: 'Virgil van Dijk',    role: 'Defensa · Liverpool',         celebImg: 'https://upload.wikimedia.org/wikipedia/commons/5/5d/20160604_AUT_NED_8876_%28cropped%29.jpg' },
  { id: 'japan',         group: 'F', brand: 'Adidas',  jerseyImg: 'assets/uniforme japon.webp',                        celebName: 'Takumi Minamino',    role: 'Mediocampista · Monaco',      celebImg: 'https://upload.wikimedia.org/wikipedia/commons/1/16/Minamino_asse_asm_2425.png' },
  { id: 'sweden',        group: 'F', brand: 'Adidas',  jerseyImg: 'assets/uniforme suecia.webp',                        celebName: 'Zlatan Ibrahimović', role: 'Delantero · Leyenda',          celebImg: 'https://upload.wikimedia.org/wikipedia/commons/0/09/Zlatan_Ibrahimovi%C4%87_June_2018.jpg' },
  { id: 'tunisia',       group: 'F', brand: 'Kappa',   jerseyImg: 'assets/uniforme tunez.webp',                         celebName: 'Wahbi Khazri',       role: 'Delantero · Montpellier',     celebImg: 'https://upload.wikimedia.org/wikipedia/commons/8/86/Wahbi_Khazri.jpg' },
  // Grupo G: Bélgica · Egipto · RI de Irán · Nueva Zelanda
  { id: 'belgium',       group: 'G', brand: 'Adidas',  jerseyImg: 'assets/uniforme belgica.webp',                        celebName: 'Kevin De Bruyne',    role: 'Mediocampista · Man. City',   celebImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Kevin_De_Bruyne_USMNT_v_Belgium_Mar_28_2026-64_%28cropped%29.jpg/960px-Kevin_De_Bruyne_USMNT_v_Belgium_Mar_28_2026-64_%28cropped%29.jpg' },
  { id: 'egypt',         group: 'G', brand: 'Nike',    jerseyImg: 'assets/uniforme egipto.webp',                    celebName: 'Mohamed Salah',      role: 'Extremo · Liverpool',         celebImg: 'https://upload.wikimedia.org/wikipedia/commons/4/4a/Mohamed_Salah_2018.jpg' },
  { id: 'iran',          group: 'G', brand: 'Meyba',   jerseyImg: 'assets/uniforme iran.webp',                     celebName: 'Mehdi Taremi',       role: 'Delantero · Inter Milan',     celebImg: 'https://upload.wikimedia.org/wikipedia/commons/7/74/Iran_-_Japan%2C_AFC_Asian_Cup_2019_42_%28cropped%29.jpg' },
  { id: 'newzealand',    group: 'G', brand: 'Nike',    jerseyImg: 'assets/uniforme nueva z.webp',                        celebName: 'Chris Wood',         role: 'Delantero · Nottm Forest',    celebImg: 'https://upload.wikimedia.org/wikipedia/commons/8/8e/New_Zealand-Portugal_%28155_%28cropped%29.jpg' },
  // Grupo H: España · Cabo Verde · Arabia Saudí · Uruguay
  { id: 'spain',         group: 'H', brand: 'Adidas',  jerseyImg: 'assets/uniforme españa.webp',                        celebName: 'Lamine Yamal',       role: 'Extremo · FC Barcelona',      celebImg: 'https://upload.wikimedia.org/wikipedia/commons/e/e3/Lamine_Yamal_in_2025.jpg' },
  { id: 'saudiarabia',   group: 'H', brand: 'Nike',    jerseyImg: 'assets/uniforme saudi.webp',            celebName: 'Salem Al-Dawsari',   role: 'Extremo · Al-Hilal',          celebImg: 'https://upload.wikimedia.org/wikipedia/commons/6/6d/Salem_Al-Dawsari_2018.jpg' },
  { id: 'uruguay',       group: 'H', brand: 'Puma',    jerseyImg: 'assets/uniforme uruguay.webp',                  celebName: 'Luis Suárez',        role: 'Delantero · River Plate',     celebImg: 'https://upload.wikimedia.org/wikipedia/commons/f/f7/Luis_Su%C3%A1rez_2026_%28cropped%29.jpg' },
  { id: 'cabov',         group: 'H', brand: 'Nike',    jerseyImg: 'assets/uniforme cabo v.webp',                  celebName: 'Erling Haaland',     role: 'Delantero · Man. City',       celebImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Erling_Haaland_June_2025.jpg/960px-Erling_Haaland_June_2025.jpg' },
  // Grupo I: Francia · Senegal · Irak · Noruega
  { id: 'france',        group: 'I', brand: 'Nike',    jerseyImg: 'assets/uniforme francia.webp',                  celebName: 'Kylian Mbappé',      role: 'Delantero · Real Madrid',     celebImg: 'https://upload.wikimedia.org/wikipedia/commons/6/66/Picture_with_Mbapp%C3%A9_%28cropped_and_rotated%29.jpg' },
  { id: 'senegal',       group: 'I', brand: 'Puma',    jerseyImg: 'assets/uniforme senegal.webp',                  celebName: 'Sadio Mané',         role: 'Extremo · Al-Nassr',          celebImg: 'https://upload.wikimedia.org/wikipedia/commons/1/1a/Sadio_Mane_Al-Nassr.jpg' },
  { id: 'norway',        group: 'I', brand: 'Nike',    jerseyImg: 'assets/uniforme noruega.webp',                  celebName: 'Erling Haaland',     role: 'Delantero · Man. City',       celebImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Erling_Haaland_June_2025.jpg/960px-Erling_Haaland_June_2025.jpg' },
  { id: 'irak',          group: 'I', brand: 'Nike',    jerseyImg: 'assets/uniforme iraq.webp',                  celebName: 'Erling Haaland',     role: 'Delantero · Man. City',       celebImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Erling_Haaland_June_2025.jpg/960px-Erling_Haaland_June_2025.jpg' },
  // Grupo J: Argentina · Argelia · Austria · Jordania
  { id: 'argentina',     group: 'J', brand: 'Adidas',  jerseyImg: 'assets/uniforme argentina.webp',                celebName: 'Lionel Messi',       role: 'Delantero · Inter Miami',     celebImg: 'https://upload.wikimedia.org/wikipedia/commons/6/6b/Lionel_Messi_White_House_2026_%283x4_cropped%29.jpg' },
  { id: 'algeria',       group: 'J', brand: 'Puma',    jerseyImg: 'assets/uniforme argelia.webp',                  celebName: 'Riyad Mahrez',       role: 'Extremo · Al-Ahli',           celebImg: 'https://upload.wikimedia.org/wikipedia/commons/4/45/Mahrez_2021.jpg' },
  { id: 'austria',       group: 'J', brand: 'Puma',    jerseyImg: 'assets/uniforme austria.webp',                  celebName: 'David Alaba',        role: 'Defensa · Real Madrid',       celebImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/20180610_FIFA_Friendly_Match_Austria_vs._Brazil_David_Alaba_850_1632.jpg/960px-20180610_FIFA_Friendly_Match_Austria_vs._Brazil_David_Alaba_850_1632.jpg' },
  { id: 'jordania',      group: 'J', brand: 'Nike',    jerseyImg: 'assets/uniforme jordania.webp',                 celebName: 'David Alaba',        role: 'Defensa · Real Madrid',       celebImg: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/20180610_FIFA_Friendly_Match_Austria_vs._Brazil_David_Alaba_850_1632.jpg/960px-20180610_FIFA_Friendly_Match_Austria_vs._Brazil_David_Alaba_850_1632.jpg' },
  // Grupo K: Portugal · RD Congo · Uzbekistán · Colombia
  { id: 'portugal',      group: 'K', brand: 'Nike',    jerseyImg: 'assets/uniforme portugal.webp',                 celebName: 'Cristiano Ronaldo',  role: 'Delantero · Al-Nassr',        celebImg: 'https://upload.wikimedia.org/wikipedia/commons/9/9c/President_Donald_Trump_meets_with_Cristiano_Ronaldo_in_the_Oval_Office_%2854933344262%29_%28cropped_and_rotated%29.jpg' },
  { id: 'colombia',      group: 'K', brand: 'Adidas',  jerseyImg: 'assets/uniforme colombia.webp',                 celebName: 'Luis Díaz',          role: 'Extremo · Liverpool',         celebImg: 'https://upload.wikimedia.org/wikipedia/commons/c/c7/FC_RB_Salzburg_gegen_FC_Bayern_M%C3%BCnchen_%282026-01-06_Testspiel%29_40_%28Luiz_D%C3%ADaz%29.jpg' },
  { id: 'congo',         group: 'K', brand: 'Adidas',    jerseyImg: 'assets/uniforme congo.webp',                    celebName: 'Cristiano Ronaldo',  role: 'Delantero · Al-Nassr',        celebImg: 'https://upload.wikimedia.org/wikipedia/commons/9/9c/President_Donald_Trump_meets_with_Cristiano_Ronaldo_in_the_Oval_Office_%2854933344262%29_%28cropped_and_rotated%29.jpg' },
  { id: 'uzbekistan',    group: 'K', brand: 'Adidas',  jerseyImg: 'assets/uniforme uzbekistan.webp',                 celebName: 'Luis Díaz',          role: 'Extremo · Liverpool',         celebImg: 'https://upload.wikimedia.org/wikipedia/commons/c/c7/FC_RB_Salzburg_gegen_FC_Bayern_M%C3%BCnchen_%282026-01-06_Testspiel%29_40_%28Luiz_D%C3%ADaz%29.jpg' },
  // Grupo L: Inglaterra · Croacia · Ghana · Panamá
  { id: 'england',       group: 'L', brand: 'Nike',    jerseyImg: 'assets/uniforme england.webp',                        celebName: 'Jude Bellingham',    role: 'Mediocampista · Real Madrid', celebImg: 'https://upload.wikimedia.org/wikipedia/commons/f/f9/25th_Laureus_World_Sports_Awards_-_Red_Carpet_-_Jude_Bellingham_-_240422_190551-2_%28cropped%29.jpg' },
  { id: 'croatia',       group: 'L', brand: 'Nike',    jerseyImg: 'assets/uniforme croacia.webp',                        celebName: 'Luka Modrić',        role: 'Mediocampista · Real Madrid', celebImg: 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Ofrenda_de_la_Liga_y_la_Champions-57-L.Mill%C3%A1n_%2852109310843%29_%28Luka_Modri%C4%87%29.jpg' },
  { id: 'ghana',         group: 'L', brand: 'Nike',    jerseyImg: 'assets/uniforme ghana.webp',                        celebName: 'Thomas Partey',      role: 'Mediocampista · Arsenal',     celebImg: 'https://upload.wikimedia.org/wikipedia/commons/4/42/ATL-Madrid-Lokomotiv001-Thomas_%28cropped%29.jpg' },
  { id: 'panama',        group: 'L', brand: 'Nike',    jerseyImg: 'assets/uniforme panama.webp',                        celebName: 'Thomas Partey',      role: 'Mediocampista · Arsenal',     celebImg: 'https://upload.wikimedia.org/wikipedia/commons/4/42/ATL-Madrid-Lokomotiv001-Thomas_%28cropped%29.jpg' },
];
...
// UNIFORMS PAGE
// ============================================================
function WCUniformsPage({ tweaks, onBack, onNavigate }) {
  ...
  return (
    <div style={{ background: bg, minHeight: '100vh' }}>
      ...
      <section style={{ padding: '0 clamp(20px, 4vw, 48px) clamp(48px, 6vw, 80px)', textAlign: 'center' }}>
        <button onClick={() => onNavigate ? onNavigate('selecciones') : onBack()} style={{
