...
const ALL_TEAMS = [
  ...
  { id: 'haiti',         name: 'Haití',            code: 'HAI', group: 'C', gradient: 'linear-gradient(145deg, #00209F, #D21034)', flag: '🇭🇹', dark: true,  hasDetail: true, ranking: 83, titles: 0, flagCode: 'ht', image: 'https://images.unsplash.com/HlseIzr_6fI?w=400&h=530&fit=crop&q=75' },
  { id: 'scotland',      name: 'Escocia',          code: 'SCO', group: 'C', gradient: 'linear-gradient(145deg, #003078, #00205B)', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', dark: true,  hasDetail: true, ranking: 43, titles: 0, flagCode: 'gb-sct', image: 'https://images.unsplash.com/OlbCWO7068Y?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'paraguay',      name: 'Paraguay',         code: 'PAR', group: 'D', gradient: 'linear-gradient(145deg, #D52B1E, #0038A8)', flag: '🇵🇾', dark: true,  hasDetail: true, ranking: 40, titles: 0, flagCode: 'py', image: 'https://images.unsplash.com/S0LqHCU-GIM?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'curacao',       name: 'Curazao',          code: 'CUW', group: 'E', gradient: 'linear-gradient(145deg, #002B7F, #F9E814)', flag: '🇨🇼', dark: true,  hasDetail: true, ranking: 82, titles: 0, flagCode: 'cw', image: 'https://images.unsplash.com/hHVEUp73ok4?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'capeverde',     name: 'Cabo Verde',       code: 'CPV', group: 'H', gradient: 'linear-gradient(145deg, #003893, #CF2027)', flag: '🇨🇻', dark: true,  hasDetail: true, ranking: 69, titles: 0, flagCode: 'cv', image: 'https://images.unsplash.com/IMZdIiZPDRo?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'senegal',       name: 'Senegal',          code: 'SEN', group: 'I', gradient: 'linear-gradient(145deg, #00853F, #FDEF42)', flag: '🇸🇳', dark: true,  hasDetail: true, ranking: 14, titles: 0, flagCode: 'sn', image: 'https://images.unsplash.com/QuCvjY4gCng?w=400&h=530&fit=crop&q=75' },
  { id: 'iraq',          name: 'Irak',             code: 'IRQ', group: 'I', gradient: 'linear-gradient(145deg, #CE1126, #007A3D)', flag: '🇮🇶', dark: true,  hasDetail: true, ranking: 57, titles: 0, flagCode: 'iq', image: 'https://images.unsplash.com/C3wwqfFRBck?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'jordan',        name: 'Jordania',         code: 'JOR', group: 'J', gradient: 'linear-gradient(145deg, #007A3D, #CE1126)', flag: '🇯🇴', dark: true,  hasDetail: true, ranking: 63, titles: 0, flagCode: 'jo', image: 'https://images.unsplash.com/5_Bu25SV6X8?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'rdcongo',       name: 'RD Congo',         code: 'COD', group: 'K', gradient: 'linear-gradient(145deg, #007FFF, #CE1126)', flag: '🇨🇩', dark: true,  hasDetail: true, ranking: 46, titles: 0, flagCode: 'cd', image: 'https://images.unsplash.com/StJWD4ci8wY?w=400&h=530&fit=crop&q=75' },
  { id: 'uzbekistan',    name: 'Uzbekistán',       code: 'UZB', group: 'K', gradient: 'linear-gradient(145deg, #1EB53A, #CE2028)', flag: '🇺🇿', dark: true,  hasDetail: true, ranking: 50, titles: 0, flagCode: 'uz', image: 'https://images.unsplash.com/hvLu3ABC1n0?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'ghana',         name: 'Ghana',            code: 'GHA', group: 'L', gradient: 'linear-gradient(145deg, #CE1126, #006B3F)', flag: '🇬🇭', dark: true,  hasDetail: true, ranking: 74, titles: 0, flagCode: 'gh', image: 'https://images.unsplash.com/E9NPWGBXM9o?w=400&h=530&fit=crop&q=75' },
