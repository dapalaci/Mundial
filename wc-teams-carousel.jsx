...
const ALL_TEAMS = [
  ...
  { id: 'czechrepublic', name: 'República Checa',  code: 'CZE', group: 'A', gradient: 'linear-gradient(145deg, #D7141A, #11457E)', flag: '🇨🇿', dark: true,  hasDetail: true, ranking: 41, titles: 0, flagCode: 'cz', image: 'https://images.unsplash.com/photo-1519677584237-752f8853252e?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'haiti',         name: 'Haití',            code: 'HAI', group: 'C', gradient: 'linear-gradient(145deg, #00209F, #D21034)', flag: '🇭🇹', dark: true,  hasDetail: true, ranking: 83, titles: 0, flagCode: 'ht', image: 'https://images.unsplash.com/photo-1604977042946-1eecc30f269e?w=400&h=530&fit=crop&q=75' },
  { id: 'scotland',      name: 'Escocia',          code: 'SCO', group: 'C', gradient: 'linear-gradient(145deg, #003078, #00205B)', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', dark: true,  hasDetail: true, ranking: 43, titles: 0, flagCode: 'gb-sct', image: 'https://images.unsplash.com/photo-1531177071211-ed1b7741e7b5?w=400&h=530&fit=crop&q=75' },
  // Grupo D: Estados Unidos · Paraguay · Australia · Turquía
  { id: 'usa',           name: 'Estados Unidos',   code: 'USA', group: 'D', gradient: 'linear-gradient(145deg, #002868, #BF0A30)', flag: '🇺🇸', dark: true,  hasDetail: true, ranking: 16, titles: 0, flagCode: 'us', image: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=400&h=530&fit=crop&q=75' },
  { id: 'paraguay',      name: 'Paraguay',         code: 'PAR', group: 'D', gradient: 'linear-gradient(145deg, #D52B1E, #0038A8)', flag: '🇵🇾', dark: true,  hasDetail: true, ranking: 40, titles: 0, flagCode: 'py', image: 'https://images.unsplash.com/photo-1583427053955-ea2c34cfbc49?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'curacao',       name: 'Curazao',          code: 'CUW', group: 'E', gradient: 'linear-gradient(145deg, #002B7F, #F9E814)', flag: '🇨🇼', dark: true,  hasDetail: true, ranking: 82, titles: 0, flagCode: 'cw', image: 'https://images.unsplash.com/photo-1540655037529-dec987208707?w=400&h=530&fit=crop&q=75' },
  { id: 'cotedivoire',   name: 'Costa de Marfil',  code: 'CIV', group: 'E', gradient: 'linear-gradient(145deg, #F77F00, #009A44)', flag: '🇨🇮', dark: true,  hasDetail: true, ranking: 34, titles: 0, flagCode: 'ci', image: 'https://images.unsplash.com/photo-1609252809097-e47b0a0c9fce?w=400&h=530&fit=crop&q=75' },
  { id: 'ecuador',       name: 'Ecuador',          code: 'ECU', group: 'E', gradient: 'linear-gradient(145deg, #FFD100, #034EA2)', flag: '🇪🇨', dark: true,  hasDetail: true, ranking: 23, titles: 0, flagCode: 'ec', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=530&fit=crop&q=75' },
  // Grupo F: Países Bajos · Japón · Suecia · Túnez
  { id: 'netherlands',   name: 'Países Bajos',     code: 'NED', group: 'F', gradient: 'linear-gradient(145deg, #FF6600, #21468B)', flag: '🇳🇱', dark: true,  hasDetail: true, ranking: 7,  titles: 0, flagCode: 'nl', image: 'https://images.unsplash.com/photo-1524047934617-cb782c24e5f3?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'egypt',         name: 'Egipto',           code: 'EGY', group: 'G', gradient: 'linear-gradient(145deg, #C8102E, #1A1A1A)', flag: '🇪🇬', dark: true,  hasDetail: true, ranking: 29, titles: 0, flagCode: 'eg', image: 'https://images.unsplash.com/photo-1568322445389-f64ac2515020?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'capeverde',     name: 'Cabo Verde',       code: 'CPV', group: 'H', gradient: 'linear-gradient(145deg, #003893, #CF2027)', flag: '🇨🇻', dark: true,  hasDetail: true, ranking: 69, titles: 0, flagCode: 'cv', image: 'https://images.unsplash.com/photo-1590736969596-c06e8d82ece4?w=400&h=530&fit=crop&q=75' },
  { id: 'saudiarabia',   name: 'Arabia Saudí',     code: 'KSA', group: 'H', gradient: 'linear-gradient(145deg, #006C35, #004D28)', flag: '🇸🇦', dark: true,  hasDetail: true, ranking: 61, titles: 0, flagCode: 'sa', image: 'https://images.unsplash.com/photo-1578895102408-2cb7bbe88c53?w=400&h=530&fit=crop&q=75' },
  { id: 'uruguay',       name: 'Uruguay',          code: 'URU', group: 'H', gradient: 'linear-gradient(145deg, #0038A8, #5BA3D4)', flag: '🇺🇾', dark: true,  hasDetail: true, ranking: 17, titles: 2, flagCode: 'uy', image: 'https://images.unsplash.com/photo-1608528577891-eb055944f2e7?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'senegal',       name: 'Senegal',          code: 'SEN', group: 'I', gradient: 'linear-gradient(145deg, #00853F, #FDEF42)', flag: '🇸🇳', dark: true,  hasDetail: true, ranking: 14, titles: 0, flagCode: 'sn', image: 'https://images.unsplash.com/photo-1607863680198-23d4b2565df0?w=400&h=530&fit=crop&q=75' },
  { id: 'iraq',          name: 'Irak',             code: 'IRQ', group: 'I', gradient: 'linear-gradient(145deg, #CE1126, #007A3D)', flag: '🇮🇶', dark: true,  hasDetail: true, ranking: 57, titles: 0, flagCode: 'iq', image: 'https://images.unsplash.com/photo-1599840843577-a86fe18b4dc5?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'algeria',       name: 'Argelia',          code: 'ALG', group: 'J', gradient: 'linear-gradient(145deg, #006233, #D21034)', flag: '🇩🇿', dark: true,  hasDetail: true, ranking: 28, titles: 0, flagCode: 'dz', image: 'https://images.unsplash.com/photo-1532274402911-5a369e4c4bb5?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'jordan',        name: 'Jordania',         code: 'JOR', group: 'J', gradient: 'linear-gradient(145deg, #007A3D, #CE1126)', flag: '🇯🇴', dark: true,  hasDetail: true, ranking: 63, titles: 0, flagCode: 'jo', image: 'https://images.unsplash.com/photo-1553913861-c0fdba5e7ab1?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'rdcongo',       name: 'RD Congo',         code: 'COD', group: 'K', gradient: 'linear-gradient(145deg, #007FFF, #CE1126)', flag: '🇨🇩', dark: true,  hasDetail: true, ranking: 46, titles: 0, flagCode: 'cd', image: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=400&h=530&fit=crop&q=75' },
  { id: 'uzbekistan',    name: 'Uzbekistán',       code: 'UZB', group: 'K', gradient: 'linear-gradient(145deg, #1EB53A, #CE2028)', flag: '🇺🇿', dark: true,  hasDetail: true, ranking: 50, titles: 0, flagCode: 'uz', image: 'https://images.unsplash.com/photo-1575978374804-4dc0e9f1c21e?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'croatia',       name: 'Croacia',          code: 'CRO', group: 'L', gradient: 'linear-gradient(145deg, #C8102E, #0044AA)', flag: '🇭🇷', dark: true,  hasDetail: true, ranking: 11, titles: 0, flagCode: 'hr', image: 'https://images.unsplash.com/photo-1600158238971-a38c4e25ef65?w=400&h=530&fit=crop&q=75' },
  { id: 'ghana',         name: 'Ghana',            code: 'GHA', group: 'L', gradient: 'linear-gradient(145deg, #CE1126, #006B3F)', flag: '🇬🇭', dark: true,  hasDetail: true, ranking: 74, titles: 0, flagCode: 'gh', image: 'https://images.unsplash.com/photo-1627467958889-22e72e93d8f5?w=400&h=530&fit=crop&q=75' },
