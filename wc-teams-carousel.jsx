...
const ALL_TEAMS = [
  ...
  { id: 'bosnia',        name: 'Bosnia y Herz.',   code: 'BIH', group: 'B', gradient: 'linear-gradient(145deg, #002395, #FCCA03)', flag: '🇧🇦', dark: true,  hasDetail: true, ranking: 65, titles: 0, flagCode: 'ba', image: 'https://images.unsplash.com/photo-1541701494587-cb58502866a6?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'haiti',         name: 'Haití',            code: 'HAI', group: 'C', gradient: 'linear-gradient(145deg, #00209F, #D21034)', flag: '🇭🇹', dark: true,  hasDetail: true, ranking: 83, titles: 0, flagCode: 'ht', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=530&fit=crop&q=75' },
  { id: 'scotland',      name: 'Escocia',          code: 'SCO', group: 'C', gradient: 'linear-gradient(145deg, #003078, #00205B)', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', dark: true,  hasDetail: true, ranking: 43, titles: 0, flagCode: 'gb-sct', image: 'https://images.unsplash.com/photo-1506377585622-bedcbb027afc?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'paraguay',      name: 'Paraguay',         code: 'PAR', group: 'D', gradient: 'linear-gradient(145deg, #D52B1E, #0038A8)', flag: '🇵🇾', dark: true,  hasDetail: true, ranking: 40, titles: 0, flagCode: 'py', image: 'https://images.unsplash.com/photo-1597006312768-59c78eb44d93?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'curacao',       name: 'Curazao',          code: 'CUW', group: 'E', gradient: 'linear-gradient(145deg, #002B7F, #F9E814)', flag: '🇨🇼', dark: true,  hasDetail: true, ranking: 82, titles: 0, flagCode: 'cw', image: 'https://images.unsplash.com/photo-1565967511849-76a60a516170?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'capeverde',     name: 'Cabo Verde',       code: 'CPV', group: 'H', gradient: 'linear-gradient(145deg, #003893, #CF2027)', flag: '🇨🇻', dark: true,  hasDetail: true, ranking: 69, titles: 0, flagCode: 'cv', image: 'https://images.unsplash.com/photo-1559128010-7c1ad6e1d6a3?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'senegal',       name: 'Senegal',          code: 'SEN', group: 'I', gradient: 'linear-gradient(145deg, #00853F, #FDEF42)', flag: '🇸🇳', dark: true,  hasDetail: true, ranking: 14, titles: 0, flagCode: 'sn', image: 'https://images.unsplash.com/photo-1611348586804-61bf6c080437?w=400&h=530&fit=crop&q=75' },
  { id: 'iraq',          name: 'Irak',             code: 'IRQ', group: 'I', gradient: 'linear-gradient(145deg, #CE1126, #007A3D)', flag: '🇮🇶', dark: true,  hasDetail: true, ranking: 57, titles: 0, flagCode: 'iq', image: 'https://images.unsplash.com/photo-1586190848861-5aa38d31eb7c?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'jordan',        name: 'Jordania',         code: 'JOR', group: 'J', gradient: 'linear-gradient(145deg, #007A3D, #CE1126)', flag: '🇯🇴', dark: true,  hasDetail: true, ranking: 63, titles: 0, flagCode: 'jo', image: 'https://images.unsplash.com/photo-1549885861-f6cdc04d1e39?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'rdcongo',       name: 'RD Congo',         code: 'COD', group: 'K', gradient: 'linear-gradient(145deg, #007FFF, #CE1126)', flag: '🇨🇩', dark: true,  hasDetail: true, ranking: 46, titles: 0, flagCode: 'cd', image: 'https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?w=400&h=530&fit=crop&q=75' },
  { id: 'uzbekistan',    name: 'Uzbekistán',       code: 'UZB', group: 'K', gradient: 'linear-gradient(145deg, #1EB53A, #CE2028)', flag: '🇺🇿', dark: true,  hasDetail: true, ranking: 50, titles: 0, flagCode: 'uz', image: 'https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400&h=530&fit=crop&q=75' },
  ...
  { id: 'ghana',         name: 'Ghana',            code: 'GHA', group: 'L', gradient: 'linear-gradient(145deg, #CE1126, #006B3F)', flag: '🇬🇭', dark: true,  hasDetail: true, ranking: 74, titles: 0, flagCode: 'gh', image: 'https://images.unsplash.com/photo-1577249486885-d38e3a611fe3?w=400&h=530&fit=crop&q=75' },
  { id: 'panama',        name: 'Panamá',           code: 'PAN', group: 'L', gradient: 'linear-gradient(145deg, #DA121A, #003688)', flag: '🇵🇦', dark: true,  hasDetail: true, ranking: 33, titles: 0, flagCode: 'pa', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=530&fit=crop&q=75' },
];
